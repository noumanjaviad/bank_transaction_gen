...
<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        ...
        {{-- <div class="navbar-nav w-100">
            ...
            <a href="{{route('get_form')}}" class="nav-item nav-link active"><i class="fa fa-keyboard me-2"></i>Customer</a>
        ...
        <div class="navbar-nav w-100">
            ...
            <a href="{{ route('get_form') }}"
                ...
                <i class="fa fa-keyboard me-2"></i>Customer
            </a>
            ...
            <a href="{{ route('get_dubai_islamic_customers') }}"
                ...
                <i class="fa fa-chart-bar text-nowrap"></i>Dubai Islamic Bank
            </a>
        </div>
